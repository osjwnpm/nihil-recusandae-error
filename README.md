# @osjwnpm/nihil-recusandae-error ![CI](https://github.com/osjwnpm/nihil-recusandae-error/workflows/CI/badge.svg) [![NPM version](https://img.shields.io/npm/v/@osjwnpm/nihil-recusandae-error.svg?style=flat)](https://npmjs.org/package/@osjwnpm/nihil-recusandae-error) [![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-yellow.svg)](https://conventionalcommits.org) <!-- omit from toc -->
...
💼 [Configurations](https://github.com/osjwnpm/nihil-recusandae-error#presets) enabled in.\
✅ Set in the `recommended` [configuration](https://github.com/osjwnpm/nihil-recusandae-error#presets).\
